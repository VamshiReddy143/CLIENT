          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            >
              {({ isActive }) => (
                <>
                  <span
                    className={`absolute left-0 top-0 h-full  rounded-l-lg transition-all duration-300 ease-in-out ${isActive ? 'bg-orange-500' : 'bg-transparent group-hover:bg-orange-500'
                      }`}
                  />
                  {isActive && (
                  ...
                  <h2 className="text-lg lg:text-[17px] font-medium">Dashboard</h2>
                </>
              )}
            </NavLink>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <h2 className="text-lg lg:text-[17px] font-medium">Vendors</h2>
                </>
              )}
            </NavLink>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <svg width="25" height="27" viewBox="0 0 25 27" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${svgClass} ${isActive ? 'fill-white' : 'fill-[#B8BED9] group-hover:fill-white'}`}>
                    <path d="M24.0502 24.8848V20.7598C24.0502 19.6048 23.8852 18.4498 23.2252 17.2948C22.5652 16.1398 21.7402 15.1498 20.5852 14.4898C19.4302 13.6648 16.9552 13.4998 15.8002 13.4998L13.1602 16.3048L14.1502 18.4498V23.3998L12.5002 25.2148L10.8502 23.3998V18.4498L12.0052 16.3048L9.2002 13.4998C7.8802 13.4998 5.4052 13.6648 4.2502 14.4898C3.0952 15.1498 2.4352 16.1398 1.7752 17.2948C1.1152 18.4498 0.950195 19.4398 0.950195 20.7598V24.8848C0.950195 24.8848 5.2402 26.6998 12.5002 26.6998C19.7602 26.6998 24.0502 24.8848 24.0502 24.8848ZM12.5002 0.464844C9.3652 0.464844 7.5502 3.43484 8.0452 6.73484C8.5402 10.0348 10.1902 12.3448 12.5002 12.3448C14.8102 12.3448 16.4602 10.0348 16.9552 6.73484C17.4502 3.26984 15.6352 0.464844 12.5002 0.464844Z"
                     fill="currentColor" />
                  </svg>


                
                  <h2 className="text-lg lg:text-[17px] font-medium">Market Owners</h2>
                </>
              )}
            </NavLink>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <h2 className="text-lg lg:text-[17px] font-medium">Listings</h2>
                </>
              )}
            </NavLink>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <h2 className="text-lg lg:text-[17px] font-medium">Settings</h2>
                </>
              )}
            </NavLink>
          </div>
