            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  />
                  {isActive && (
                    <span className="absolute left-[-26px] top-0 rounded-r-[10px] h-full w-[40px] bg-orange-500 -translate-x-full transition-all duration-300 ease-in-out" />
                  )}
                  <svg
                    width="32"
                    height="32"
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <h2 className="text-lg lg:text-[15px] font-medium">Vendors</h2>
                </>
              )}
            </NavLink>

            <NavLink
              to="/market-owner/Requests"
              className={({ isActive }) =>
                `relative group flex gap-4 items-center p-4 rounded-xl transition-all duration-300 ease-in-out ${isActive
                  ? 'bg-orange-500 text-white'
                  : 'text-gray-600 hover:bg-orange-500 hover:text-white'
